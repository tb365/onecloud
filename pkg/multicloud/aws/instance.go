...
func (self *SInstance) RebuildRoot(ctx context.Context, desc *cloudprovider.SManagedVMRebuildRootConfig) (string, error) {
	...
	if strings.ToLower(image.GetOsType()) != strings.ToLower(osprofile.OS_TYPE_WINDOWS) {

	} else {
		// powershell scripts
		if strings.ToLower(self.GetOSType()) != strings.ToLower(osprofile.OS_TYPE_WINDOWS) {
